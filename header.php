...
<html lang="en">
  <head>
    ...
    <title> مؤسســــة عالــــم الاكتشـــاف </title>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-xs-12 col-sm-4">
          <div class="logo-div">
            ...
            <div class="lang">
              ...
              <a href="en/index.php"><img src="images/en.jpg" alt="en"></a>
            </div>
          </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-5">
          <div class="company">
            <h2>مؤسســــة عالــــم الاكتشـــاف </h2>
             <p> أجهزة كشف الذهب والكنوز والمياه الجوفية </p>
          </div>
        </div>
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
       ...
       <li><a href="categories.php">اجهزتنا </a></li>
         <li><a href="buy.php">الشراء </a></li>
